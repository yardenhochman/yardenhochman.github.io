  ...
  <section className="container-fluid">
    ...
    <footer>
      <div className="social_media_links">
        <a title="Github" target="_blank" href={`https://github.com/${github}`}>
        ...
        <a
          title="Resume"
          target="_blank"
          href={`https://github.com/yardenhochman/yardenhochman.github.io/raw/master/src/file/Yarden%20Hochman%20CV.pdf`}
          className="resume"
        />
